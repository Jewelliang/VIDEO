...
<head>
    ...
    <title>在线公开课学习平台|java|大数据|HTML5|python|UI|PHP视频教程</title>
            ...
            <div class="course-info">
                <table cellspacing="10">
                    <tr>
                        <td colspan="2">
                            <a href="front/course/index.action?subjectId=1">
                                <img src="static/img/html5.png" alt="" class="image scale" draggable="false">
                                <div class="headline">
                                    <span>Web前端教程</span>
                        ...
                        <td colspan="2">
                            ...
                            <a href="front/course/index.action?subjectId=6">
                                <img src="static/img/ui.png" alt="" class="image scale" draggable="false">
                                <div class="headline">
                                    <span>UI设计教程</span>
                                    <img src="static/img/arrow.png" alt="">
                                </div>
                     ...
                     <tr>
                        <td colspan="2">
                            <a href="front/course/index.action?subjectId=2" >
                                <img src="static/img/java.png" alt="" class="image scale" draggable="false">
                                <div class="headline">
                                    <span>Java教程</span>
                                    <img src="static/img/arrow.png" alt="">
                                </div>
                    ...
                    <td colspan="2">
                        ...
                        <td colspan="2">
                            <a href="front/course/index.action?subjectId=5">
