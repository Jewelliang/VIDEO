...
<body>
	...
	<div class="container">
		...
		<form class="form-horizontal" action="admin/speaker/edit.action"
			method="post">
			...
			<div class="form-group">
				...
				<div class="col-sm-5">
					<input type="text" class="form-control" name="speakerName"
						id="speakerName" value="${speaker.speakerName }"
						placeholder="主讲人姓名">
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-5">
					<input type="text" class="form-control" name="speakerJob"
						id="speakerJob" value="${speaker.speakerJob }" placeholder="主讲人职业">
				</div>
			</div>
			<div class="form-group">
				<label for="speakerHeadUrl" class="col-sm-2 control-label">头像图片</label>
				<div class="col-sm-5">
					<input type="text" class="form-control" name="speakerHeadUrl"
						id="speakerHeadUrl" value="${speaker.speakerHeadUrl }"
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<textarea class="form-control" name="speakerDescr" id="speakerDescr
						rows="3">${speaker.speakerName }</textarea>
				</div>
			</div>
			<div class="form-group">
