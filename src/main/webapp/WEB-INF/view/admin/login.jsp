		...
		<div class="col-lg-4 col-lg-offset-4 login_form">
			...
			<form class="form-horizontal" action="admin/login.action" method="post" id="loginForm">
				<div class="form-group has-success">
					<div class="col-sm-10">
						<input type="text" class="form-control  input-lg" name="loginName"
				...
				<div class="form-group has-success">
					<div class="col-sm-10">
						<input type="password" class="form-control input-lg"
							name="loginPwd" id="loginPwd" placeholder="登录密码">
					</div>
				</div>
				...
				<div class="form-group has-success">
					<div class="col-sm-10">
						记住密码 &nbsp;&nbsp;<input type="checkbox"  id="rememberMe" name="rememberMe" value="0" type="checkbox">
					</div>
				</div>
